"""
Django settings for aline_qa_environment_39 project.
...
ROOT_URLCONF = 'aline_qa_environment_39.urls'
...
WSGI_APPLICATION = 'aline_qa_environment_39.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aline_qa_environment_39 API",
    "DESCRIPTION": "API documentation for aline_qa_environment_39 App",
    "VERSION": "v1",
}
